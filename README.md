...
- **Guide Agent (`scripts/agents/run_guide_agent.py`)**: Iterative routine development, debugging, complex workflows requiring back-and-forth with the agent
...
python scripts/agents/specialists/run_trace_hound.py \
...
python scripts/agents/specialists/run_docs_digger.py

# JS Specialist - interactive JavaScript code generation
python scripts/agents/specialists/run_js_specialist.py \
...
python scripts/agents/specialists/run_interaction_specialist.py --jsonl-path ./cdp_captures/interaction/events.jsonl
```
...
python scripts/dev/run_benchmarks.py -v

# Use a specific model
python scripts/dev/run_benchmarks.py --model gpt-4.1

# Custom output directory
python scripts/dev/run_benchmarks.py --output-dir ./my_benchmarks
```
