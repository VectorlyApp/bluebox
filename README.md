...
Everything below covers how to reverse-engineer web apps and build your own routines from scratch. If you just want to run existing routines, the [BlueBox Agent](#bluebox-agent) above is all you need.
