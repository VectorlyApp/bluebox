...
Contains:
- PathFinderAgent: Traces values across network, storage, and window property data
...
class PathFinderAgent:
    """
    Path finder agent that traces where tokens/values originated from.
    ...
    def __init__(
        ...
        """
        Initialize the path finder agent.
        ...
        logger.debug(
            "Instantiated PathFinderAgent with model: %s, chat_thread_id: %s",
            llm_model,
            self._thread.id,
        )
