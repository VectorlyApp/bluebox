...
**Code:** [operation.py](bluebox/data_models/routine/operation.py), [endpoint.py](bluebox/data_models/routine/endpoint.py)
...
5. **Match parameter types to CDP** - If the raw request sends `"5"` (string), use `type=string`
