...
class TestStripProxyCredentials:
    ...
    def test_strips_user_and_password(self) -> None:
        assert strip_proxy_credentials("http://user:pass@proxy.example.com:8080") == "http://proxy.example.com:8080"

    def test_strips_user_only(self) -> None:
        assert strip_proxy_credentials("http://user@proxy.example.com:8080") == "http://proxy.example.com:8080"

    def test_no_credentials_unchanged(self) -> None:
        assert strip_proxy_credentials("http://proxy.example.com:8080") == "http://proxy.example.com:8080"

    def test_no_port(self) -> None:
        assert strip_proxy_credentials("http://user:pass@proxy.example.com") == "http://proxy.example.com"

    def test_https_scheme(self) -> None:
        assert strip_proxy_credentials("https://user:pass@proxy.example.com:443") == "https://proxy.example.com:443"

    def test_socks5_scheme(self) -> None:
        assert strip_proxy_credentials("socks5://user:pass@10.0.0.1:1080") == "socks5://10.0.0.1:1080"

    def test_ip_address_host(self) -> None:
        assert strip_proxy_credentials("http://admin:secret@192.168.1.1:3128") == "http://192.168.1.1:3128"
    ...
    def test_special_chars_in_password(self) -> None:
        assert strip_proxy_credentials("http://user:p%40ss%3Aword@proxy.example.com:8080") == "http://proxy.example.com:8080"
