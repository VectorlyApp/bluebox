...
class TestToolDefinitionsStructure:
    ...
    def test_all_parameters_are_valid_json_schema(self):
...
class TestScanForValueTool:
    ...
    def test_before_transaction_id_optional(self):
...
class TestAddTransactionToQueueTool:
    ...
    def test_requires_transaction_id_and_reason(self):
...
class TestRecordExtractedVariablesTool:
    ...
    def test_requires_transaction_id_and_variables(self):
...
class TestRecordResolvedVariableTool:
    ...
    def test_optional_source_objects(self):
...
class TestGetToolByName:
    ...
    def test_returns_correct_tool(self):
...
class TestGetAllToolNames:
    ...
    def test_matches_tool_definitions(self):
